...
{     
      ...
      /*Si no es menor de 9 (la ultima posición del vector para escribir), 
      activa bandera para que termine la interrupción.
      NOTA: recuerden que la interrupción se atiende de forma asincrona, si no controlan el tamaño del indice se puede
      ...
      */
      ...
      /*
      Buscar si se metieron o no datos correctos no es función de la interrupción. Recuerden rapidas y cortas
      Esta validación debe de ser en otro lugar.
      */
...
void main(void)
{
   ...
   {   
      /*
      JAMAS (en serio JAMAS) manipulamos las variables que se manipulan dentro de la interrupción dentro del ciclo principal.
      En tu caso estas bloqueando el flujo del programa pero es una pésima práctica.
      */
      ...
      /*
      Aqui estas bloqueando a que se termine la RDA, pero y si no recibe nada y superó el tiempo? 
      Ocupas una función que analice todo o cambiar la orrganización de tu programa
      */
